...
L'artefatto principale del capitolo è il:
...
L'obiettivo è allenare la capacità di passare da richiesta a problema, da problema a outcome e da outcome a un perimetro delegabile.
