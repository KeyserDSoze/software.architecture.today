...
- allineamento con eventuali policy ESI condivise quando verranno introdotte.
...
**Esigenza:** buon livello di performance e availability per gli operatori.

**Tensione:** massimizzare availability/performance vs costo e complessità operativa.

**Decisione:** soluzione semplice finché workload e requisiti non dimostrano il bisogno di componenti aggiuntivi.

**Costo accettato:** non massimizziamo ridondanza, caching e indipendenza regionale.

**Quality floor:** correctness, security e operability non vengono sacrificate per risparmiare complessità.

**Guardrail:** misurazioni, NFR espliciti e trigger di revisione.
...
Queste fonti sostengono il metodo di partire da business/workload requirements e valutare trade-off; i requisiti specifici di Order Operations restano simulati.